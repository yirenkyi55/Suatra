...
namespace Suatra.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20221114042324_UpdatedUserEntityRefreshTokenExpiry")]
    partial class UpdatedUserEntityRefreshTokenExpiry
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.Course", b =>
                {
                    ...
                    b.Property<string>("CoverVideoUri")
                        .HasMaxLength(256)
                        .IsUnicode(false)
                        .HasColumnType("varchar(256)");
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.SectionContent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.SubCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Suatra.Domain.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.SectionContent", b =>
                {
                    b.HasOne("Suatra.Domain.Entities.CourseSection", "CourseSection")
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.SubCategory", b =>
                {
                    b.HasOne("Suatra.Domain.Entities.Category", "Category")
            ...
            modelBuilder.Entity("Suatra.Domain.Entities.Topic", b =>
                {
                    b.HasOne("Suatra.Domain.Entities.SubCategory", "SubCategory")
                        .WithMany("Topics")
